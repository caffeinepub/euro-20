...
export class Backend implements backendInterface {
    ...
    async getStreakData(arg0: Principal): Promise<StreakData> {
        if (this.processError) {
            try {
                const result = await this.actor.getStreakData(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordDayCompletion(arg0: bigint): Promise<UpdateResult> {
        if (this.processError) {
            try {
                const result = await this.actor.recordDayCompletion(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordDayCompletionForUser(arg0: Principal, arg1: bigint): Promise<UpdateResult> {
        if (this.processError) {
            try {
                const result = await this.actor.recordDayCompletionForUser(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
